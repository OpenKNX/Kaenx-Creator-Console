...
$OpenKNX_ToolName = "Kaenx.Creator.Console"
...
Copy-Item scripts/Install-$($OpenKNX_ToolName).json  release/tools/  # This is the json file for the Install-OpenKNX-Tools.ps1 script
